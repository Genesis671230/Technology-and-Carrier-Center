    ...
    <section className="mb-32 text-gray-800 text-center md:text-left">
      ...
      <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
        <div className="mb-6 md:mb-0">
          <div
            ...
            <img src="https://source.unsplash.com/random/1600x1200/?dubai-school"
        ...
        <div className="mb-6 md:mb-0">
          <h3 className="text-2xl font-bold mb-3">Welcome to MBZ Campus</h3>
      ...
      <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
        ...
        <div className="mb-6 md:mb-0 md:order-1">
          <h3 className="text-2xl font-bold mb-3">Exhibition in Al Ain</h3>
      ...
      <div className="grid md:grid-cols-2 gap-x-6 xl:gap-x-12 items-center mb-12">
        ...
        <div className="mb-6 md:mb-0">
          <h3 className="text-2xl font-bold mb-3">Exhibition in Dubai</h3>
