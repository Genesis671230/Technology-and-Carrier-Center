        ...
        <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
          <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
            <h2 className="text-2xl text-gray-800 font-bold sm:text-3xl dark:text-gray-200">
              Empowering futures, ENS emerging project Technology and Carrier
              Center
            </h2>
                ...
                <span className="flex">
                  ...
                  <span className="grow ml-6">
                    ...
                    <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                      The Technology and Career Center provide you with hands-on
                      practices needed for your future career and your
                      day-to-day life. equipped with machines to create designs
              ...
              <button
                ...
                <span className="flex">
                  ...
                  <span className="grow ml-6">
                    ...
                    <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                      Do you want to become the next Emiratie Astronaut, Artist
                      or Scientist? TCC helps you to discover your talents by
                      choosing the right courses where you can create your own
                      individual project and helps you define your future career
                      path
                    </span>
                  </span>
                </span>
              ...
              <button
                ...
                <span className="flex">
                  ...
                  <span className="grow ml-6">
                    ...
                    <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                      TCC starts with an orientation course where we discover
                      together your interests and talents Next stage we will
                      train on basic skills to learn how to use tools and learn
                      basic practical knowledge by doing small exciting projects
                      Stage three will be the practical part where you take part
          ...
          <div className="lg:col-span-6">
            <div className="relative">
              <div>
                {/* {reasonsTccObject.find(item)=>item.id==selectedReason} */}
                <div
                  id="tabs-with-card-1"
                  role="tabpanel"
